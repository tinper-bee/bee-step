...
}, _defineProperty(_propTypes, 'direction', _react.PropTypes.oneOf(['horizontal', 'vertical'])), _defineProperty(_propTypes, 'size', _react.PropTypes.oneOf(['default', 'small'])), _propTypes);
